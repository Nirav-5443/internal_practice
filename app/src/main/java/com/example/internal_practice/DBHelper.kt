...
data class DBHelper(val context : Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION){
    companion object{
    ...
    override fun onCreate(p0: SQLiteDatabase?){
        var query = "CREATE TABLE $TB_NAME($ID INTEGER PRIMARY KEY AUTOINCREMENT,$NAME TEXT, $AGE INTEGER)"
        p0?.execSQL(query)
    }
